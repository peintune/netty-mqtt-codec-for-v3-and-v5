...
import io.netty.v3v5.codec.mqtt.*;
...
public class MqttCodecTest {
    ...
    private static MqttSubscribeMessage createSubscribeMessage() {
        ...
        topicSubscriptions.add(new MqttTopicSubscription("/abc", SubscriptionOption.onlyFromQos(MqttQoS.AT_LEAST_ONCE)));
        topicSubscriptions.add(new MqttTopicSubscription("/def", SubscriptionOption.onlyFromQos(MqttQoS.AT_LEAST_ONCE)));
        topicSubscriptions.add(new MqttTopicSubscription("/xyz", SubscriptionOption.onlyFromQos(MqttQoS.EXACTLY_ONCE)));
