...
public class Mqtt5CodecTest {
    ...
    public void testConnectMessageForMqtt5() throws Exception {
        ...
        props.add(new MqttProperties.IntegerProperty(MqttProperties.MqttPropertyType.SESSION_EXPIRY_INTERVAL.value(), 10));
    ...
    public void testPublish() throws Exception {
        MqttProperties props = new MqttProperties();
        props.add(new MqttProperties.IntegerProperty(MqttProperties.MqttPropertyType.PAYLOAD_FORMAT_INDICATOR.value(), 6));
        final MqttPublishMessage message = MqttCodecTest.createPublishMessage(props);
        ByteBuf byteBuf = MqttEncoderV5.doEncode(ALLOCATOR, message);
    ...
    public void testSubscribe() throws Exception {
        ...
        final MqttSubscribeMessage message = MqttMessageBuilders.subscribe()
                .messageId((short) 1)
                .properties(props)
                .addSubscription("/topic", new SubscriptionOption(MqttQoS.AT_LEAST_ONCE, true, true,
    ...
    public void testDisconnect() throws Exception {
        MqttProperties props = new MqttProperties();
        props.add(new MqttProperties.IntegerProperty(MqttProperties.MqttPropertyType.SESSION_EXPIRY_INTERVAL.value(), 6));
    ...
    public void testAuth() throws Exception {
        MqttProperties props = new MqttProperties();
        props.add(new MqttProperties.BinaryProperty(MqttProperties.MqttPropertyType.AUTHENTICATION_DATA.value(), "secret".getBytes()));
