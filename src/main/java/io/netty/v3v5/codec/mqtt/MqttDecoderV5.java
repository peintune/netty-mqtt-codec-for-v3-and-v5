 ...
 *
 */
public class MqttDecoderV5 extends MqttDecoder {
    ...
    public Result<MqttSubscribePayload> decodeSubscribePayload(
        ...
        while (numberOfBytesConsumed < bytesRemainingInVariablePart) {
            ...
            SubscriptionOption.RetainedHandlingPolicy retainHandling = SubscriptionOption.RetainedHandlingPolicy.valueOf(optionByte & 0x30 >> 4);
